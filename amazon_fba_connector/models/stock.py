...
#                         total_shipped_qty+=quant.qty
    ...
    def check_qty_difference_and_create_return_picking(self,amazon_shipment_id,odoo_shipment_id,instance):
        ...
        mws_obj = Amazon_api.InboundShipments_Extend(access_key=instance.access_key and str(instance.access_key) or False,
...
class stock_inventory(models.Model):
    ...
    def import_amazon_fba_stock(self,instance):
        proxy_data=instance.seller_id.get_proxy_server()
        mws_obj = Inventory(access_key=instance.access_key and str(instance.access_key) or False,
                          secret_key=instance.secret_key and str(instance.secret_key) or False,
                          account_id=instance.merchant_id and str(instance.merchant_id) or False,
                          region=instance.country_id.amazon_marketplace_code or instance.country_id.code,
                          auth_token=instance.auth_token and str(instance.auth_token) or False,
