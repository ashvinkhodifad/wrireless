...
class ebay_description_template_line(models.Model):
    ...
    field_id = fields.Many2one("ir.model.fields", string="Field", help="Select fields name of product", domain="[('model','in',['product.product','product.template']),('ttype','in',['char','float','text','binary','datetime','integer'])]", required=True)
